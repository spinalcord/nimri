...
4. Run `./app.sh dev` after changing an accessible command or RPC type. It refreshes the frontend bindings and starts the application.
...
- Do not edit files under `frontend/generated/`; regenerate them through `./app.sh generate` if needed.
...
- Do not run `./app.sh test` during application development. It is reserved for Nimri framework maintenance.
